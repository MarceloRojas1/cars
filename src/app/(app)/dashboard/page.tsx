    ...
    <>
      ...
      <div className="mb-6 grid gap-3 lg:grid-cols-2">
        <div className="rounded-lg border bg-card p-4">
          <h2 className="mb-3 text-[15px] font-semibold">Mejor auto del mes</h2>
          <p className="text-[13px] text-muted-foreground">Sin ventas este mes</p>
        </div>
        <div className="rounded-lg border bg-card p-4">
          <h2 className="mb-3 text-[15px] font-semibold">Leads por canal</h2>
      ...
      <section className="rounded-lg border bg-card">
        <div className="flex items-center gap-2 border-b px-4 py-3">
          ...
          <h2 className="text-[15px] font-semibold">Días en salón</h2>
        ...
        <div className="px-4 py-3">
          ...
          <ul className="space-y-1.5">
            {r.enSalon.slice(0, 5).map((v) => (
              <li key={v.id} className="flex items-center gap-3 rounded-md border px-3 py-2">

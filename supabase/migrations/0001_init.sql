...
-- Cada usuario pertenece a una organización; RLS impide ver datos de otra.
-- ---------------------------------------------------------------------------
...
begin
  foreach t in array array[
    ...
    execute format(
      'create policy tenant_isolation on %I using (organization_id in (select current_org_ids()))', t);
  end loop;
end $$;
